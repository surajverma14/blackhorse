/*!
 * Modified Masonry Plugin
 * Issue was that Masonry does not fit into our Bower workflow
 * because it has dependencies on github that we override with our shorthand resolver
 * Additionally, this source file is modified to NOT use AMD because the dependency paths don't exist
 */
...
// transport
if ( typeof define === 'function' && define.amd && 1!=1 ) {
  // AMD
  define( function() {
...
function masonryDefinition( Outlayer, getSize ) {
  ...
  Masonry.prototype.measureColumns = function() {
    ...
    if ( !this.columnWidth ) {
      ...
      //   this.containerWidth;
      this.columnWidth = this._calcColumnWidth();
    }
  ...
  Masonry.prototype._calcColumnWidth = function() {
